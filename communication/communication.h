...
#define LAST_MOBILE_CMD		0x7  //last command that is not generally used for
                                 //human debugging
#define FIRST_SACC_CMD      0x7  //One or more saccade commands are
#define LAST_SACC_CMD       0x7  //internal commands used by saccFilt.c
