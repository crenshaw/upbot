...
* soarClient.c
*
* This is the client that connects to a game server.
* It receives a string defining the agent's state and passes
* it to Dr. Nuxoll's Soar agent.
*
* Author: Zachary Faltersack
*   derived from: Dr. Crenshaw, Dr. Nuxoll, Steve Beyer and Z.F.
